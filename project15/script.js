class DoList {
    ...
    static TODOSLIST_URL = 'http://jsonplaceholder.typicode.com/todos';
   ...
   static createTask(taskText){
    ...
    onTaskListClick(e){
        ...
        if(e.target.classList.contains(DoList.STATUS_DEAFAULT)){ 
            ...
            this.sendCorrectedValue(arrayTarget, arrayTarget.id);
            ...
            this.deleteFromServer(arrayTarget.id);
    ...
    sendCorrectedValue(el, i){
        fetch(DoList.TODOSLIST_URL + '/' + i, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
